...
$$
\text{Cafés por franja} =
\frac{\text{Número total de cafés en la franja}}
{\text{Número de trabajadores}}
$$
...
En este tipo de representación, los valores se representan como **nodos** y la coocurrencia entre dos valores se representa mediante una **arista** o enlace entre ellos. El peso, grosor o intensidad de la arista puede indicar la frecuencia con la que ambos valores aparecen juntos. Además, el tamaño de los nodos puede representar la frecuencia individual de cada valor, y el color puede utilizarse para distinguir comunidades, grupos o categorías.

Sus principales características son que permite visualizar relaciones entre elementos, detectar agrupaciones o comunidades, localizar nodos centrales, identificar elementos aislados y observar qué valores actúan como conectores entre grupos. Es especialmente útil en análisis de textos, redes sociales, relaciones entre categorías o cualquier problema donde interese representar asociaciones entre elementos.
