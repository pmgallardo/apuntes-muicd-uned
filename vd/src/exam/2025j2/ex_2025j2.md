...
El gráfico adecuado es una **matriz de coocurrencia o mapa de calor**.

Características:

- Ejes representan elementos.
- Las celdas muestran frecuencia de aparición conjunta.
- Uso de color para intensidad.
