...
Aunque el enunciado mencione el análisis de información, encaja más poner las fases de la creación de una representación ya que las fases de análisis se preguntan explícitamente en el apartado A del ejercicio 2.

- **Cuestión/objetivo**
  - Analizar la relación entre consumo de café y rendimiento (pedidos procesados).
- **Recolección de datos**
  - Integrar registros de café con registros de rendimiento por trabajador.
...
- **Comunicación de resultados**
  - Comprobar si responde al objetivo empresarial.
...
La razón por la que se propone un mapa de calor y no otra opción (como por ejemplo, un grafo) es porque en los apuntes de la asignatura cuando se presenta la coocurrencia se indica que el diagrama adecuado para reprentarlo es el mapa de calor.
