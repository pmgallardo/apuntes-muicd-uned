...
En el apartado "Tipos de variables" se han descrito los tipos.
...
![Metodología en espiral para el análisis de datos](./img/2_metodologia_analisis_datos.png)
...
En el diagrama anterior, tal y como se muestra en la documentación principal de la asignatura, se llama al preprocesado "selección de variables" y al procesado "análisis de datos". En estos apuntes se omiten ambos términos alternativos para que quede la terminología más uniforme entre los distintos apartados de las asignaturas donde no se usan estos términos; además, resulta confuso el uso del nombre "análisis de datos" para una de las fases de un proceso llamado con el mismo término.
...
Una regla nemotécnica es recordar la palabra "LeFT" ("izquierda" en inglés).
...
Una regla nemotécnica para recordar las iniciales de cada tarea es completar el acrónimo "OACCNE" (como la frase "*o acné*").
...
En estadística, el término también se usa a la transformación de una variable para obtener una distribución normal estandarizada, con media 0 y varianza 1. En preprocesado, este sería un ejemplo más de normalización.
