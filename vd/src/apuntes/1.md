...
Etapas del proceso para abordar una visualización:
...
![Proceso para abordar una visualización](./img/1_proceso_visualizacion.png)
...
![Roles en el proceso de visualización](./img/1_roles.png)

## Visualización en ingeniería de datos
<!-- Presentación de información” frente a “análisis de información” -->

Se distinguen dos líneas u objetivos de uso de la visualización en el área de ingeniería de datos:
