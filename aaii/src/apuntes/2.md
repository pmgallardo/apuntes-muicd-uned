...
| Método | Qué cambia en cada iteración | Árboles | Función de pérdida |
| - | - | - | - |
| AdaBoost | Aumenta explícitamente el peso de los ejemplos mal clasificados y combina clasificadores por voto ponderado | *Stumps* | Rígido (exponencial) |
| Intensificación del gradiente | Ajusta un nuevo modelo al gradiente negativo o pseudo-residuo de una función de pérdida | Cortos (3-6 niveles) | Muy flexible (diferenciable, como MSE, MAE, Log-loss) |
