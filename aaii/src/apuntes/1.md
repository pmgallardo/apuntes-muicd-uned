...
Una ventaja de Random Forest es que, al construir cada nodo, no se prueban todas las variables disponibles, sino solo un subconjunto aleatorio de $m$ variables.
