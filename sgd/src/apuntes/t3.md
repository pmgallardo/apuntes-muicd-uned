...
**MIT Kerberos** proporciona un centro de distribución de claves (*centro de distribución de claves*, KDC).

`SGD.EX.2022SO.10 / SGD.EX.2023J2.10 / SGD.EX.2023SO.10 / SGD.EX.2024SO.16 / SGD.EX.2025J2.16`

**OpenLDAP** proporciona autenticación para usuarios y grupos, compatible con LDAP.

![Posibles estructuras que permiten la integración de proveedores de identidad con servicios/aplicaciones del sistema operativo subyacente (como Hadoop/Spark)](img/3_proveedores_identidad.png)

`SGD.EX.2022J2.10 / SGD.EX.2022SO.8 / SGD.EX.2023J2.8 / SGD.EX.2024J2.10 / SGD.EX.2025J2.9`

**Microsoft Active Directory** (MSAD, o simplemente AD) integra servicios de dominio con Kerberos/KDC y LDAP; además, en el ecosistema Microsoft se integra con servicios de certificados. En el temario aparece que en Active Directory un realm Kerberos se mapea a un dominio y que AD proporciona servicios KDC y LDAP para ese dominio.
