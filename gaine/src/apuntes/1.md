...
Redis se considera aproximadamente CP ya que funciona por replicación asincrona, y como el maestro escribe sin esperar por nodos, podrían darse inconsistencias.
...
| `INSERT` | `SET`, `HSET`, `LPUSH`/`RPUSH`, `SADD`, `ZADD` | `insertOne()`, `insertMany()` | `INSERT INTO ... VALUES` | `CREATE`, `MERGE` |
