...
No puede quedar sin argumentos, y requiere un filtro explícito, aunque sea vacíod:
...
Con `aggregate` se define una tubería que contiene una o varias etapas de agregación. Estas, a su vez, pueden contenter operadores de expresión.
