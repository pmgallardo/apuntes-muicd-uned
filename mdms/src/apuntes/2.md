...
4. Determinar el **método de extracción de datos**.
5. Realizar el **preprocesado**.
5. Construir **atributos** para el análisis.
6. Determinar si hace falta **aprendizaje automático**, así como el tipo y los algoritmos.
7. Explicar el **criterio de decisión final**
