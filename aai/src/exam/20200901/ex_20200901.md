...
**Justificación:**  
En problemas convexos existe un único mínimo global, pero para alcanzarlo de forma estable es necesario un learning rate adecuado y, en métodos como descenso de gradiente estocástico (SGD), suele ser necesario reducirlo gradualmente.
...
Para $n = 10^6$, se obtiene un valor cercano a $20$. El ejercicio requiere que el alumno recuerde que $10^6 \approx 20^2$.
...
\
En un MLP con 10 entradas, una capa oculta de 50 neuronas y una capa de salida de 3 neuronas, ¿qué dimensiones tiene la matriz de pesos $W_h$ y el vector de sesgos $b_h$ de la capa oculta?
...
En una capa oculta de un MLP el cálculo es:
...
Suponiendo que hubiera una sola instancia, para que la multiplicación matricial tenga sentido:

$$(1 \times 10) \, W_h = (1 \times 50)$$

se tiene que cumplir que:

- $W_h \in \mathbb{R}^{10 \times 50}$

Por otro lado, tiene que haber un sesgo por cada neurona oculta. Además, por la fórmula tiene que tener el mismo ancho que $W_h$.
