...
Se asume que la convención que se usa en la asignatura es la que se corresponde con la práctica, que coincide con la representada en la página 305 del libro HOML 3.ª ed.:
...
Algunos libros teóricos o chatbots en ocasiones ofrecen la fórmula $\hat{Y} = \phi(W \, W + b)$, pero en la asignatura no se sigue esta convención.
...
Preguntado en AAI.EX.20200201.T.9, EX.20200901.T.9, EX.20230207.T.7 AAI.EX.20240206.T.5 y EX.20240902.T.10.
...
| Heavside | (0,1) | Discreto | - |
| Signo | (-1,1) | Discreto | - |
| Sigmoide/logística | (0,1) | Discreto | Clasificación +multiclase |
...
| Softmax | Varias salidas | Continuo | Clasificación multiclase |
