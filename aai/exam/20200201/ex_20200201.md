...
Justificación:
El coste de entrenamiento de un árbol de decisión crece aproximadamente como $O(nlogn)$. Multiplicar el tamaño por 10 implica algo más que ×10 en tiempo, dando un valor cercano a 11–12 horas.
...
\
¿Qué función de activación es la más adecuada en la capa de salida para clasificar dígitos del 0 al 9?
...
Justificación:
Softmax convierte las salidas en una distribución de probabilidad sobre 10 clases, lo que la hace ideal para clasificación multiclase mutuamente excluyente.
